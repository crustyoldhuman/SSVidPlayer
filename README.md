...
* The 300% boosted volume feature does not work on Edge/Chromium browsers due to how they pipe out their audio and the limitations of zero-dependency HTML5 page. If you want boosted volume, you'll have to switch to Firefox (oh no!). 
